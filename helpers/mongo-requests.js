...
var removeDuplicates = function (model, duplicateCriteria) {
    if (duplicateCriteria === void 0) { duplicateCriteria = []; }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, model.aggregate([
                        ...
                        {
                            $group: {
                                _id: duplicateCriteria.reduce(function (obj, item) {
                ...
                case 1:
                    ...
                    response.forEach(function (doc) {
                        ...
                        doc.ids.forEach(function (id) { return duplicateIds.push(id); }); // Getting all duplicate ids);
                    });
